...
const papers: Record<Locale, ResearchItem[]> = {
  it: [
    {
      translationKey: 'temporal-references-emergent-communication', locale: 'it', pathSlug: 'temporal-references-emergent-communication',
      title: 'It’s About Time: Temporal References in Emergent Communication',
      summary: 'Articolo JAIR su come far emergere riferimenti temporali nella comunicazione tra agenti AI: una base per sistemi autonomi più coordinati, verificabili e adatti a contesti di sicurezza.',
      image: '/images/research/temporal-references-emergent-communication.jpg', imageAttribution: { assetPath: '/images/research/temporal-references-emergent-communication.jpg', sourceUrl: 'https://unsplash.com/photos/selective-focus-photo-of-brown-and-blue-hourglass-on-stones-BXOXnQ26B7o', sourceLabel: 'Photo by Aron Visuals on Unsplash' },
      seo: { title: 'Temporal References in Emergent Communication | Ricerca', description: 'Paper JAIR sulla comunicazione temporale tra agenti AI.' }, itemType: 'paper', typeLabel: 'Articolo accademico', publishedAt: '2026-06-12', authors: ['Olaf Lipinski', 'Adam Sobey', 'Federico Cerutti', 'Timothy Norman'], tags: ['Multi-agent systems', 'Emergent communication', 'Trustworthy AI', 'Cybersecurity'], officialUrl: 'https://doi.org/10.1613/jair.1.19795',
      body: prose('Il lavoro studia come agenti artificiali possano sviluppare riferimenti al tempo nella propria comunicazione. Gli esperimenti mostrano che una piccola modifica architetturale, più che un semplice cambiamento della funzione di perdita, permette agli agenti di esprimere relazioni temporali in modo affidabile.', 'Per la cybersecurity, comunicare non solo che cosa accade ma anche quando e in quale sequenza è essenziale per coordinare il rilevamento, la risposta agli incidenti e sistemi autonomi distribuiti. Il contributo offre quindi una base per agenti più capaci di condividere contesto temporale, rendendo le loro decisioni e interazioni più comprensibili e verificabili.'),
    },
    {
      translationKey: 'charl-tre-wifi-csi-har', locale: 'it', pathSlug: 'charl-tre-wifi-csi-har', title: 'Towards Causally Interpretable Wi-Fi CSI-Based Human Activity Recognition with Discrete Latent Compression and LTL Rule Extraction', summary: 'Paper accettato a FUSION 2026 che trasforma segnali Wi-Fi in regole temporali e causali leggibili, per un sensing wireless più trasparente e controllabile.', image: '/images/research/charl-tre-wifi-csi-har.jpg', imageAttribution: { assetPath: '/images/research/charl-tre-wifi-csi-har.jpg', sourceUrl: 'https://unsplash.com/photos/purple-and-blue-light-digital-wallpaper-8bghKxNU1j0', sourceLabel: 'Photo by JJ Ying on Unsplash' }, seo: { title: 'Causally Interpretable Wi-Fi CSI | Ricerca', description: 'Paper FUSION 2026 su Wi-Fi CSI, regole LTL e AI spiegabile.' }, itemType: 'paper', typeLabel: 'Articolo accademico', publishedAt: '2026-04-24', authors: ['Luca Cotti', 'Luca Lavazza', 'Marco Cominelli', 'Liying Han', 'Gaofeng Dong', 'Francesco Gringoli', 'Mani B. Srivastava', 'Trevor Bihl', 'Erik P. Blasch', 'Daniel O. Brigham', 'Kara Combs', 'Lance M. Kaplan', 'Federico Cerutti'], tags: ['Wi-Fi CSI', 'Wireless sensing', 'Explainable AI', 'Causal AI', 'Privacy'], officialUrl: 'https://arxiv.org/abs/2604.22979', body: prose('Il lavoro propone una pipeline che comprime i segnali Wi-Fi CSI in rappresentazioni discrete e ricava regole di logica temporale lineare (LTL) per riconoscere le attività umane. Invece di affidarsi esclusivamente a un classificatore black-box, produce regole deterministiche che esplicitano dipendenze temporali e causali.', 'La rilevanza cyber sta nel rendere il sensing wireless più ispezionabile e governabile. Il Wi-Fi CSI può abilitare inferenze sensibili sulla presenza e sulle attività delle persone: comprendere le regole che guidano il modello aiuta a valutarne affidabilità, limiti e implicazioni per la privacy, oltre a favorire contromisure e fusioni multi-antenna più controllabili.'),
    },
    {
      translationKey: 'chronos-frequency-understanding', locale: 'it', pathSlug: 'chronos-frequency-understanding', title: 'Preliminary Insights in Chronos Frequency Data Understanding and Reconstruction', summary: 'Studio su come il foundation model Chronos rappresenta l’informazione in frequenza, con indicazioni utili per l’uso affidabile di AI su segnali temporali e flussi di sicurezza.', image: '/images/research/chronos-frequency-understanding.jpg', imageAttribution: { assetPath: '/images/research/chronos-frequency-understanding.jpg', sourceUrl: 'https://unsplash.com/photos/a-magnifying-glass-rests-on-a-textured-surface-pCwb5OuObls', sourceLabel: 'Photo by Sasun Bughdaryan on Unsplash' }, seo: { title: 'Chronos Frequency Data Understanding | Ricerca', description: 'Rapporto tecnico sul modello Chronos e la rappresentazione in frequenza.' }, itemType: 'technical-report', typeLabel: 'Rapporto tecnico', publishedAt: '2026-05-07', authors: ['Alessandro Pagani', 'Marco Cominelli', 'Liying Han', 'Gaofeng Dong', 'Sergio Benini', 'Francesco Gringoli', 'Mattia Savardi', 'Mani B. Srivastava', 'Trevor Bihl', 'Erik P. Blasch', 'Daniel O. Brigham', 'Kara Combs', 'Lance M. Kaplan', 'Federico Cerutti'], tags: ['Foundation models', 'Time series', 'Signal processing', 'Explainable AI', 'Cybersecurity'], officialUrl: 'https://arxiv.org/abs/2605.06361', body: prose('Questo studio analizza se e come Chronos, un foundation model per serie temporali, rappresenti le informazioni in frequenza. Attraverso sonde leggere applicate alle rappresentazioni interne del modello, gli autori valutano la presenza e la separabilità di frequenze note e individuano i regimi in cui la qualità della rappresentazione richiede maggiore cautela.', 'Per la cybersecurity, molti segnali osservati — dal traffico di rete alle misure radio, fino alla telemetria di sistemi industriali — sono temporali e spesso rivelano anomalie nella loro struttura frequenziale. Conoscere ciò che un foundation model sa davvero rappresentare è fondamentale per evitare decisioni opache o fragili e per progettare sistemi di rilevamento e data fusion più affidabili.'),
    },
    {
  ...
  en: [
    {
      translationKey: 'temporal-references-emergent-communication', locale: 'en', pathSlug: 'temporal-references-emergent-communication', title: 'It’s About Time: Temporal References in Emergent Communication', summary: 'JAIR paper on enabling temporal references in AI-agent communication, laying groundwork for more coordinated, verifiable autonomous systems in security-sensitive settings.', image: '/images/research/temporal-references-emergent-communication.jpg', imageAttribution: { assetPath: '/images/research/temporal-references-emergent-communication.jpg', sourceUrl: 'https://unsplash.com/photos/selective-focus-photo-of-brown-and-blue-hourglass-on-stones-BXOXnQ26B7o', sourceLabel: 'Photo by Aron Visuals on Unsplash' }, seo: { title: 'Temporal References in Emergent Communication | Research', description: 'JAIR paper on temporal references in AI-agent communication.' }, itemType: 'paper', typeLabel: 'Paper', publishedAt: '2026-06-12', authors: ['Olaf Lipinski', 'Adam Sobey', 'Federico Cerutti', 'Timothy Norman'], tags: ['Multi-agent systems', 'Emergent communication', 'Trustworthy AI', 'Cybersecurity'], officialUrl: 'https://doi.org/10.1613/jair.1.19795', body: prose('This work studies how artificial agents can develop temporal references in their communication. The experiments show that a small architectural change, rather than a change to the loss function alone, enables agents to express temporal relations reliably.', 'In cybersecurity, communicating not only what is happening but when and in what sequence is essential for coordinated detection, incident response, and distributed autonomous systems. The paper therefore provides a basis for agents that can share temporal context while making their interactions more understandable and verifiable.'),
    },
    {
      translationKey: 'charl-tre-wifi-csi-har', locale: 'en', pathSlug: 'charl-tre-wifi-csi-har', title: 'Towards Causally Interpretable Wi-Fi CSI-Based Human Activity Recognition with Discrete Latent Compression and LTL Rule Extraction', summary: 'FUSION 2026 paper that turns Wi-Fi signals into readable temporal and causal rules, advancing transparent and controllable wireless sensing.', image: '/images/research/charl-tre-wifi-csi-har.jpg', imageAttribution: { assetPath: '/images/research/charl-tre-wifi-csi-har.jpg', sourceUrl: 'https://unsplash.com/photos/purple-and-blue-light-digital-wallpaper-8bghKxNU1j0', sourceLabel: 'Photo by JJ Ying on Unsplash' }, seo: { title: 'Causally Interpretable Wi-Fi CSI | Research', description: 'FUSION 2026 paper on Wi-Fi CSI, LTL rules, and explainable AI.' }, itemType: 'paper', typeLabel: 'Paper', publishedAt: '2026-04-24', authors: ['Luca Cotti', 'Luca Lavazza', 'Marco Cominelli', 'Liying Han', 'Gaofeng Dong', 'Francesco Gringoli', 'Mani B. Srivastava', 'Trevor Bihl', 'Erik P. Blasch', 'Daniel O. Brigham', 'Kara Combs', 'Lance M. Kaplan', 'Federico Cerutti'], tags: ['Wi-Fi CSI', 'Wireless sensing', 'Explainable AI', 'Causal AI', 'Privacy'], officialUrl: 'https://arxiv.org/abs/2604.22979', body: prose('The paper proposes a pipeline that compresses Wi-Fi CSI signals into discrete representations and extracts Linear Temporal Logic (LTL) rules for human activity recognition. Rather than relying solely on a black-box classifier, it produces deterministic rules that make temporal and causal dependencies explicit.', 'Its cybersecurity relevance lies in making wireless sensing more inspectable and governable. Wi-Fi CSI can enable sensitive inferences about presence and activity; understanding the rules behind a model helps assess its reliability, limitations, and privacy implications, while supporting more controllable countermeasures and multi-antenna fusion.'),
    },
    {
      translationKey: 'chronos-frequency-understanding', locale: 'en', pathSlug: 'chronos-frequency-understanding', title: 'Preliminary Insights in Chronos Frequency Data Understanding and Reconstruction', summary: 'Study of how the Chronos foundation model represents frequency information, offering guidance for dependable AI on temporal signals and security-relevant data streams.', image: '/images/research/chronos-frequency-understanding.jpg', imageAttribution: { assetPath: '/images/research/chronos-frequency-understanding.jpg', sourceUrl: 'https://unsplash.com/photos/a-magnifying-glass-rests-on-a-textured-surface-pCwb5OuObls', sourceLabel: 'Photo by Sasun Bughdaryan on Unsplash' }, seo: { title: 'Chronos Frequency Data Understanding | Research', description: 'Technical report on Chronos and frequency representation.' }, itemType: 'technical-report', typeLabel: 'Technical report', publishedAt: '2026-05-07', authors: ['Alessandro Pagani', 'Marco Cominelli', 'Liying Han', 'Gaofeng Dong', 'Sergio Benini', 'Francesco Gringoli', 'Mattia Savardi', 'Mani B. Srivastava', 'Trevor Bihl', 'Erik P. Blasch', 'Daniel O. Brigham', 'Kara Combs', 'Lance M. Kaplan', 'Federico Cerutti'], tags: ['Foundation models', 'Time series', 'Signal processing', 'Explainable AI', 'Cybersecurity'], officialUrl: 'https://arxiv.org/abs/2605.06361', body: prose('This study examines whether and how Chronos, a foundation model for time series, represents frequency information. Using lightweight probes of its internal representations, the authors assess the presence and separability of known frequencies, identifying regimes in which representation quality needs particular care.', 'For cybersecurity, many observed signals — from network traffic and radio measurements to industrial-system telemetry — are temporal, with anomalies often appearing in their frequency structure. Establishing what a foundation model can truly represent is important to avoid opaque or brittle decisions and to design more dependable detection and data-fusion systems.'),
    },
    {
      translationKey: 'rapid-trust-calibration',
      locale: 'en',
